...
# version: 1.1
# new: with consideration of mouse genome [grcm38]
# ps: the script is a function and need to source by main script
# usage: gatk_pair_process [sample] [input_dir] [output_dir] [species]
...
function gatk_pair_process {
	...
	case ${4} in
		...
		;;
		mouse)
			local reference_gatk=/home/laojp/reference/mouse/ensembl_GRCm38/Mus_musculus.GRCm38.dna.primary_assembly.fa
			local reference_dbsnp=/home/laojp/reference/mouse/ensembl_GRCm38/00-All.vcf.gz
			local reference_indel=/home/laojp/reference/mouse/ensembl_GRCm38/mgp.v5.merged.indels.dbSNP142.normed.pass.sort.vcf
	esac
